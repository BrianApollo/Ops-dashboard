...
export interface UsePrelaunchUploaderOptions {
...
export interface UsePrelaunchUploaderReturn {
...
export function usePrelaunchUploader({
  accessToken,
  adAccountId,
  videos,
  pollIntervalMs = 5000,
  maxPollAttempts = 60,
}: UsePrelaunchUploaderOptions): UsePrelaunchUploaderReturn {
  // ---------------------------------------------------------------------------
  // STATE
  // ---------------------------------------------------------------------------
